#######################################################################################
####likelihood functions of observing different types of clusters followed by      ####         
...
#--cluster with unknown numder of generations--#
multi_cenFun=function(s,j,R0,k){
  if(length(s)==0) return(0)
  censorl=0
  for (i in 1:length(s)){
    l=0
